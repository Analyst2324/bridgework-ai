...
async function generateAndDownloadPDF(text, filename="CrossBorder-CV.pdf", templateId="modern"){
  try{
    ...
    // First normalize the text to add proper line breaks
    const normalized=text
      ...
      .replace(/\s+[•·▪]\s*/g,"\n• ")
      .replace(/\s{2,}•\s*/g,"\n• ")
      // Force newline before job entries (patterns like "Title | Company" or "Title — Company")
      .replace(/([a-z])\s{2,}([A-Z])/g,"$1\n$2")
      .replace(/\.\s{2,}([A-Z])/g,".\n$1");

    const rawLines=normalized.split("\n").map(l=>l.trim()).filter(l=>l);

    const SECTION_HEADERS=["PROFESSIONAL SUMMARY","SUMMARY","CORE COMPETENCIES","KEY COMPETENCIES","SKILLS","TECHNICAL SKILLS","PROFESSIONAL EXPERIENCE","WORK EXPERIENCE","EXPERIENCE","EMPLOYMENT","EDUCATION","CERTIFICATIONS","CERTIFICATION","EARLY CAREER","ADDITIONAL","AWARDS","AWARD","VOLUNTEER","LANGUAGES","PROJECTS","PUBLICATIONS","ACHIEVEMENTS","REFERENCES","PROFILE","OBJECTIVE","SYSTEMS & TOOLS","SYSTEMS AND TOOLS"];
    ...
    for(const line of rawLines){
      ...
      if(line.startsWith("•")||line.startsWith("-")){
        ...
        wrapDraw(bt,font,9.5,ML+16,maxW-16,14,DARK);
        lineIndex++;
        continue;
      }
...
const TEMPLATES=[
  {id:"classic",name:"Classic",icon:"📄",desc:"Clean, traditional, ATS-safe",best:"Finance · Law · Government",
   styles:{nameBold:true,nameSize:16,nameColor:[0.05,0.1,0.2],accentColor:[0.2,0.2,0.2],headerColor:[0.1,0.1,0.1],ruleColor:[0.6,0.6,0.6],ruleThick:0.5,bodySize:9.5,headerBold:true,sidebarBg:null}},
  {id:"modern",name:"Modern",icon:"⚡",desc:"Bold header, gold accents",best:"Tech · Consulting · Strategy",
   styles:{nameBold:true,nameSize:18,nameColor:[0.05,0.11,0.16],accentColor:[0.91,0.66,0.22],headerColor:[0.91,0.66,0.22],ruleColor:[0.91,0.66,0.22],ruleThick:1.5,bodySize:9.5,headerBold:true,sidebarBg:null}},
  {id:"executive",name:"Executive",icon:"👔",desc:"Authoritative, strong hierarchy",best:"Director · VP · C-Suite",
   styles:{nameBold:true,nameSize:20,nameColor:[0.0,0.0,0.0],accentColor:[0.15,0.25,0.45],headerColor:[0.15,0.25,0.45],ruleColor:[0.15,0.25,0.45],ruleThick:2,bodySize:10,headerBold:true,sidebarBg:null}},
  {id:"minimal",name:"Minimal",icon:"✨",desc:"Ultra-clean, elegant spacing",best:"Design · Creative · Startups",
   styles:{nameBold:false,nameSize:17,nameColor:[0.1,0.1,0.1],accentColor:[0.5,0.5,0.5],headerColor:[0.4,0.4,0.4],ruleColor:[0.85,0.85,0.85],ruleThick:0.5,bodySize:9.5,headerBold:false,sidebarBg:null}},
];
