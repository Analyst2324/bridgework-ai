    ...
    try{
      ...
      if(isStructured){
          ...
          sec.items?.forEach(item=>{
            if(item.type==="job"){
              ...
              item.bullets?.forEach(b=>{
                chk(15);
                pg.drawText("\u2022 ",{x:ML+6,y,size:9,font:F,color:GR}); // trailing space: guards the seam before the bullet's own text object
                wrap(cl(b),F,9.5,ML+16,CW-16,13.5,BK);
              });
              ...
              chk(15);
              pg.drawText("\u2022 ",{x:ML+6,y,size:9,font:F,color:GR});
              wrap(cl(item.text||""),F,9.5,ML+16,CW-16,13.5,BK);
            }else{
              chk(14);
        ...
        for(const line of lines){
          ...
          if(isBul){chk(14);pg.drawText("\u2022 ",{x:ML+4,y,size:9,font:F,color:GR});wrap(cl(line.replace(/^[•*\-]\s*/,"")),F,9.5,ML+14,CW-14,14,BK);y-=1;idx++;pt="bul";continue;}
